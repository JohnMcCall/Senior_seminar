...
\section{Zero Knowledge Compilers}
	...
	\subsection{ZKCrypt}
		Almeida et al. in~\cite{ZKCrypt:2012} present ZKCrypt, an optimizing cryptographic
		compiler. Similar to the above languages, ZKCrypt is also based on $\Sigma$-Protocols.
		...
		\textit{verified compilation}, where the correctness of a compiler is proved once and for
		all, and \textit{verifying compilation}, where the correctness of a compiler is checked on
