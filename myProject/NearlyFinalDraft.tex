...
\section{Zero Knowledge Protocols}
	...
	A proof is zero knowledge if, for every feasible
	strategy, i.e. a strategy that is both sound and complete,
	there exists a feasible computation $C^{*}$ so that the
	following two statements are computationally indistinguishable:
